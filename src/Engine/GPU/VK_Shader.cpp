...
void VK_Shader::CreateFromText(const char* pVertexShader, const char* pFragmentShader)
{
	m_pVertexSh = CreateShaderModuleDirctly(pVertexShader, shaderc_vertex_shader);
	m_pFragmentSh = CreateShaderModuleDirctly(pFragmentShader, shaderc_fragment_shader);
}
